...
public abstract class Tuple12<//
  ...
  /**
   * Creates a {@link Tuple12} of 12 elements.
   *
   * @param <T0>  type of 0th element
   * @param <T1>  type of 1th element
   * @param <T2>  type of 2th element
  ...
  /**
   * Gets a {@link Tuple11} with all the elements of this tuple skipping the first
   * one.
   *
   * @return the tail of this tuple as {@code Tuple11}
   */
  @Override
  public Tuple11<//
      T1, //
