...
public abstract class Tuple15<//
  ...
  /**
   * Creates a {@link Tuple15} of 15 elements.
   *
   * @param <T0>  type of 0th element
   * @param <T1>  type of 1th element
   * @param <T2>  type of 2th element
  ...
  /**
   * Gets a {@link Tuple14} with all the elements of this tuple skipping the first
   * one.
   *
   * @return the tail of this tuple as {@code Tuple14}
   */
  @Override
  public Tuple14<//
      T1, //
