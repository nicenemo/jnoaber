...
public interface VarArgMath {
	 ...
	 * @param items the items to calculate the average from
	 * @return the average
	 */
	 ...
	 * @param items the items to calculate the statistics on
	 ...
	 * @param items the items to calculate the maximum from
	 * @return the maximum
	 */
	 ...
	 * @param items the items to calculate the minimum from
	 * @return the maximum
	 */
	 ...
	 * @param accumulator the reducing operator
	...
	public default <T> T reduce(BinaryOperator<T> accumulator, @SuppressWarnings("unchecked") T ...items){
		...
		if (result.isPresent()){
			...
			throw new IllegalStateException(String.format("reducing with binary operator %s failed",accumulator.getClass().getCanonicalName()));
		}
	}
	
	/**
	 * Reduce a number of items.
	 * @param identity the identity, e.g. 0 for addition, 1 for multiplication.
	 * @param accumulator the reducing operator
	 * @param items the items to be reduced
	 ...
	 * @param items the items to sum the minimum from
	 * @return the maximum
	 */
