 ...
 * @param <T6>
 *            type of sixth argument
 * @param <T7>
 *            type of seventh argument
 * @param <T8>
 *            type of eight argument
 * @param <T9>
 *            type of ninth argument
 * @param <T10>
 *            type of tenth argument
 * @param <T11>
 *            type of eleventh argument
 * @param <T12>
 *            type of twelfth argument
 * @param <R>
 *            type of result
 */
@FunctionalInterface
public interface Function12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, R> {
	...
	default <V> Function12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, V> andThen(
		...
		return (T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7, T8 t8, T9 t9, T10 t10, T11 t11, T12 t12) -> after
				.apply(apply(t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12));
	}
}
